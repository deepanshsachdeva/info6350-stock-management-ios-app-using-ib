...
class DeleteStockViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func deleteStock(_ sender: UIButton) {
        ds.stocks.remove(at: selRow!)
        
        let alert = UIAlertController(title: "Success", message: "stock deleted", preferredStyle: UIAlertController.Style.alert)
